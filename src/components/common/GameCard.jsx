...
const GameCard = ({ title, thumbnail, short_description, genre, game_url, id }) => {
  return (
    <article className="block overflow-hidden max-w-[280px] h-[438px] bg-gray-700 rounded-xl shadow-xl transition-all hover:scale-105 flex-shrink-0 hover:shadow-md hover:shadow-slate-600">
      <img
        src={thumbnail}
        alt={`${title} thumbnail`}
        className="rounded-t-xl h-[158px] hover:scale-105 transition-all"
        loading="lazy"
      />
